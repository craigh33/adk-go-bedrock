...
- [`examples/bedrock-agentcore-browser`](examples/bedrock-agentcore-browser): AgentCore Browser via [`tools/agentcore/browser`](tools/agentcore/browser); starts managed browser sessions, navigates, extracts text, and saves screenshots as artifacts.
- [`examples/bedrock-agentcore-code-interpreter`](examples/bedrock-agentcore-code-interpreter): ADK runner with the [`codeinterpreter`](tools/agentcore/codeinterpreter) tool—AgentCore Code Interpreter execution with artifact inputs and outputs.
