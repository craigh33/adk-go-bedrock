...
- **US Bedrock region** (for example `AWS_REGION=us-east-1`) — Web Grounding for Nova is documented for US regions. For current regional availability, see [Amazon Bedrock pricing](https://aws.amazon.com/bedrock/pricing/).
